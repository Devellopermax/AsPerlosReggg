...
if(!['813409274621067316'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
const tag = '∳'   
const erkekrol = message.guild.roles.cache.find(r => r.id === '813409274570866709') 
const erkekrol2 = message.guild.roles.cache.find(r => r.id === '813409274553565242')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '813409274553565240')
const genelchat = message.guild.channels.cache.find(c => c.id === '813409275632287792')
const savelog = message.guild.channels.cache.find(c => c.id === '813409274914668555')
